...
# @Time    : 2018/3/3 21:29
# @Author  : CycloneBoy
# @Site    : 爬微信公众号内容，查找到的历史文章保存数据，并能把关键字制成词云
# @File    : wechatScrapy.py
# @Software: PyCharm
...
class weichat_spider:
    def __init__(self, ):
        self.check = True
        self.htmlPath = 'F:/wechatData/'
        self.PicPath = 'F:/wechatData/'
        self.headers = None
    ...
    # 从数据库查询公众号列表
    def getSubList(self):
        self.config = {'host': '127.0.0.1', 'port': 3306, 'user': 'root', 'passwd': '123456', 'db': 'wechat', 'charset': 'utf8'}
